...
@QuestConditionMark(conditionID = "checkRPGmeLevel")
public class RmCheckLevelCondition extends QuestCondition{
	private static final long serialVersionUID = 1L;
	private Integer amount;
	private String skillType;
	private String operation;
	public RmCheckLevelCondition() {
	...
	public boolean check(Player p) {
		...
		int current = api.getLevel(p, SkillType.getByAlias(skillType));
		switch (operation) {
		case "EQUAL":
